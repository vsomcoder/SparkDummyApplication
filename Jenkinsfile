            ...
            parallel {
                stage('gw02') {
                    steps {
                        ...
                        sh '''sshpass -p $ITVERSITY_PSW -e sftp -oBatchMode=no -b - $ITVERSITY_USR@gw02.itversity.com << !
                ...
                stage('gw03') {
                    steps {
                        ...
                        sh '''sshpass -p $ITVERSITY_PSW -e sftp -oBatchMode=no -b - $ITVERSITY_USR@gw03.itversity.com << !
                           put SparkWordCount/target/SparkWordCount-1.0-SNAPSHOT.jar
                           bye
                        !'''
                    }
